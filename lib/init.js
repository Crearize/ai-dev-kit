...
function setupClaudeCode(projectDir, selectedStacks) {
  ...
  setupToolBase({ projectDir, toolDir: claudeDir, selectedStacks, toolName: 'Claude Code' });
...
function setupCursor(projectDir, selectedStacks) {
  ...
  setupToolBase({ projectDir, toolDir: cursorDir, selectedStacks, toolName: 'Cursor' });
