 ...
 * @param {string[]} params.selectedStacks - Selected tech stacks
 * @param {string} params.toolName - Tool name for display
 * @param {Object} [fileOptions] - Options passed to file operations
 */
function setupToolBase({ projectDir, toolDir, selectedStacks, toolName }, fileOptions = {}) {
...
function setupClaudeCode(projectDir, selectedStacks, fileOptions = {}) {
  ...
  setupToolBase({ projectDir, toolDir: claudeDir, selectedStacks, toolName: 'Claude Code' }, fileOptions);
...
function setupCursor(projectDir, selectedStacks, fileOptions = {}) {
  ...
  setupToolBase({ projectDir, toolDir: cursorDir, selectedStacks, toolName: 'Cursor' }, fileOptions);
